...
//    {
//        public static class CommandExecutor1
//        {
...
//            public class InvalidCoinNameException : CommandExecutionException
//            {
//                public InvalidCoinNameException(string coinName) : base(formatExceptionMessage(coinName))
//                {
...
//            public class InvalidCoinSymbolException : CommandExecutionException
//            {
//                public InvalidCoinSymbolException(string coinSymbol) : base(formatExceptionMessage(coinSymbol))
//                {
